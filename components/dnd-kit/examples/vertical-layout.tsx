...
export const VerticalBasicSetup = () => <Sortable {...props} />;

export const WithoutDragOverlay = () => (
  <Sortable {...props} useDragOverlay={false} />
);

export const VerticalDragHandle = () => <Sortable {...props} handle />;
...
export const VerticalPressDelay = () => (
  <Sortable
    {...props}
...
export const VerticalMinimumDistance = () => (
  <Sortable
    {...props}
    activationConstraint={{
      distance: 15,
...
export const VerticalRemovableItems = () => {
