...
const UnsplashLogo: React.FC<LogoProps> = ({ width = 100 }) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 457.2 104.2"
			width={width}
			height={(width * 104.2) / 457.2}
			className="fill-white"
			aria-label="Unsplash logo (light version)"
		>
...
const UnsplashBranding: React.FC<UnsplashLogoProps> = ({ width = 80 }) => {
	return <UnsplashLogo width={width} />
}
