    ...
    <div className="w-full flex flex-col items-center justify-center rounded">
      <div className="flex flex-col sm:flex-row items-start sm:space-x-4 max-w-[600px]">
        ...
        <div className="flex flex-col space-y-1">
          <Typography variant="caption" color="text.secondary" className="w-full flex justify-center sm:justify-start">
            @{username}
          </Typography>
          <Typography variant="h6" color="text.primary" className="w-full min-w-[200px] text-center sm:text-left">
            {name}
          </Typography>
          <div className="flex flex-col space-y-1">
