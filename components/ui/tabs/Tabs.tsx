...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex justify-center w-full border-b border-border",
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "px-4 py-2 font-medium text-sm text-muted-foreground hover:text-foreground focus:outline-none focus:text-foreground data-[state=active]:text-primary data-[state=active]:border-b-2 data-[state=active]:border-primary",
