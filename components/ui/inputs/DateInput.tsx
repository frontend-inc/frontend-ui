...
export default function DateInput({
  ...
  return (
    <div className={cn("flex", direction === 'column' ? "flex-col space-y-2" : "flex-row items-center space-x-2")}>
      ...
      <Popover>
        <PopoverTrigger asChild>
          ...
          >
            ...
            {date ? moment(date).format("MMMM D, YYYY") : <span>{placeholder || "Pick a date"}</span>}
          </Button>
        </PopoverTrigger>
