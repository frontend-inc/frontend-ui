...
const ProductCard = React.forwardRef<HTMLDivElement, ProductCardProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <Stack className="p-4 space-y-4 w-full h-full justify-between items-between" spacing={1}>
        <Box className="h-full">
          ...
          {secondary && (
            <Typography className="text-sm text-muted-foreground mt-1" variant="body2">
              {secondary}
            </Typography>
          )}
        </Box>
