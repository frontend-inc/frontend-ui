...
export const DOCUMENT_FORM_FIELDS = {
	...
	article: [IMAGE, TITLE, HTML, PUBLISHED_AT, LABEL, CATEGORY, TAGS],
	place: [
		CONTENT_TYPE,
		IMAGE,
		TITLE,
	...
	file: [CONTENT_TYPE, FILE, TITLE, SUBTITLE, CATEGORY, DESCRIPTION, TAGS],
	youtube: [
		CONTENT_TYPE,
		IMAGE,
		YOUTUBE_VIDEO,
...
export const DOCUMENT_SHOW_FIELDS = {
	...
	event: [IMAGE, TITLE, SUBTITLE, LOCATION, CATEGORY, DESCRIPTION, TAGS],
