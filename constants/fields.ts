...
export const DOCUMENT_FORM_FIELDS = {
	post: [IMAGE, HANDLE, TITLE, LABEL, CATEGORY, DESCRIPTION, TAGS],
	article: [
		IMAGE,
		HANDLE,
		TITLE,
	...
	person: [IMAGE, HANDLE, NAME, ABOUT, SUBTITLE, CATEGORY, DESCRIPTION, TAGS],
	product: [
		IMAGE,
		HANDLE,
		TITLE,
	...
	image: [IMAGE, HANDLE, TITLE, SUBTITLE, LABEL, CATEGORY, TAGS],
	video: [
		IMAGE,
		VIDEO,
		HANDLE,
	...
	file: [FILE, HANDLE, TITLE, SUBTITLE, LABEL, CATEGORY, DESCRIPTION, TAGS],
	youtube: [
		IMAGE,
		YOUTUBE_VIDEO,
		HANDLE,
...
export const DOCUMENT_SHOW_FIELDS = {
	post: [IMAGE, TITLE, CATEGORY, SUBTITLE, DESCRIPTION, TAGS],
	article: [IMAGE, TITLE, PUBLISHED_AT, CATEGORY, SUBTITLE, DESCRIPTION, TAGS],
	place: [IMAGE, TITLE, CATEGORY, SUBTITLE, DESCRIPTION, LOCATION, TAGS],
	person: [IMAGE, NAME, CATEGORY, SUBTITLE, ABOUT, TAGS],
	event: [
		IMAGE,
		TITLE,
		CATEGORY,
	...
	product: [IMAGE, TITLE, PRICE, CATEGORY, SUBTITLE, DESCRIPTION, TAGS],
	image: [IMAGE, TITLE, SUBTITLE, DESCRIPTION, TAGS],
	video: [VIDEO, TITLE, CATEGORY, SUBTITLE, DESCRIPTION, TAGS],
	audio: [AUDIO, TITLE, CATEGORY, SUBTITLE, DESCRIPTION, TAGS],
