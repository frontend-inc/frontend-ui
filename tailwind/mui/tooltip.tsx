      ...
      <ShadcnTooltip delayDuration={300}>
        ...
        <TooltipContent
          ...
          className={cn(
            ...
            arrow && "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
            contentClassName
          )}
        >
          {title}
