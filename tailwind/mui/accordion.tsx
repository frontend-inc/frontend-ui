...
const AccordionSummary: React.FC<React.ComponentProps<typeof ShadcnAccordionTrigger> & {
...
const AccordionDetails: React.FC<React.ComponentProps<typeof ShadcnAccordionContent>> = ({ 
  children, 
  ...props 
}) => {
...
const AccordionWrapper: React.FC<React.ComponentProps<typeof ShadcnAccordionItem>> = ({ 
  children, 
  ...props 
}) => {
